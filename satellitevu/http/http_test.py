...
class TestHttp:
    ...
    def test_http_client(self, http_client_class, method):
    ...
    @title("HTTP client user agent")
    def test_http_client_user_agent(self, http_client_class):
        client = http_client_class()
    ...
    @title("Client with custom actor")
    def test_http_custom_actor(self, http_client_class):
    ...
    def test_http_set_auth(self, http_client_class, url, headers, uses_injected_auth):
    ...
    @title("Payload")
    def test_payload(self, http_client_class, data, json, body, content_type):
        client = http_client_class()
